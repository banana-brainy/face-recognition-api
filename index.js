...
const db = (0, knex_1.default)({
    client: 'pg',
    connection: {
        host: 'postgres://db_for_face_detection_api_user:PWAeLAIVZoupfMpABzjwcivcd55rcDcb@dpg-cg1fbol269vfsns5stp0-a.frankfurt-postgres.render.com/db_for_face_detection_api',
